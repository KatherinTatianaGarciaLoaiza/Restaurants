package com.reactive.programacionreactiva.server.service;

import com.reactive.programacionreactiva.server.model.Restaurant;
import com.reactive.programacionreactiva.server.model.RestaurantRepository;
...
public class RestaurantService {
    ...
    private Flux<Restaurant> doSomethingSlow(Flux<Restaurant> restaurantFlux) {
        Flux<Long> durationFlux = Flux.interval(Duration.ofMillis(700)).onBackpressureDrop();
